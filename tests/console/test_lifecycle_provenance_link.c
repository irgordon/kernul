/*
 * tests/console/test_lifecycle_provenance_link.c
 *
 * Link-check for lifecycle provenance dependency boundary symbols.
 * Pass condition: successful link against provenance implementation with
