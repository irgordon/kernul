...
.PHONY: all test clean test_sched_api.o test_cpu_state_api.o \
        ...
        test_session_retry_authorization_storage_include_ban.o \
         ...
         test_lifecycle_documentation_contract_compile.o \
         test_lifecycle_documentation_include_ban.o \
         test_lifecycle_audit_contract_compile.o \
         test_lifecycle_audit_include_ban.o \
         test_lifecycle_export_contract_compile.o \
         ...
         test_lifecycle_governance_index_contract_compile.o \
         test_lifecycle_governance_index_include_ban.o \
         test_lifecycle_governance_provenance_contract_compile.o \
         ...
         test_lifecycle_governance_manifest_contract_compile.o \
         test_lifecycle_governance_manifest_include_ban.o \
...
test: tests/test_boot tests/test_list tests/test_spinlock tests/test_thread \
                                ...
                                tests/console/test_session_retry_outcome_link \
                                 ...
                                 tests/console/test_lifecycle_provenance_include_ban.o \
                                  ...
                                  tests/console/test_lifecycle_freeze_enforcement_link \
                                   tests/console/test_lifecycle_documentation_contract_compile.o \
                                   tests/console/test_lifecycle_documentation_include_ban.o \
                                   ...
                                   tests/console/test_lifecycle_audit_include_ban.o \
                                    ...
                                    tests/console/test_lifecycle_governance_include_ban.o \
                                     ...
                                     tests/console/test_lifecycle_governance_index_contract_compile.o \
                                     tests/console/test_lifecycle_governance_index_include_ban.o \
                                     ...
                                     tests/console/test_lifecycle_governance_compatibility_include_ban.o \
                                      ...
                                      tests/console/test_lifecycle_governance_manifest_contract_compile.o \
                                      tests/console/test_lifecycle_governance_manifest_include_ban.o \
                                      tests/console/test_lifecycle_governance_manifest_link \
	...
	@echo "test_lifecycle_documentation_contract_compile: compile-check passed."
	@echo "test_lifecycle_documentation_include_ban: compile-check passed."
	./tests/console/test_lifecycle_documentation_link && echo "test_lifecycle_documentation_link: passed." || echo "test_lifecycle_documentation_link: FAILED."
	@echo "test_lifecycle_audit_contract_compile: compile-check passed."
	@echo "test_lifecycle_audit_include_ban: compile-check passed."
	./tests/console/test_lifecycle_audit_link && echo "test_lifecycle_audit_link: passed." || echo "test_lifecycle_audit_link: FAILED."
	@echo "test_lifecycle_export_contract_compile: compile-check passed."
	@echo "test_lifecycle_export_include_ban: compile-check passed."
	./tests/console/test_lifecycle_export_link && echo "test_lifecycle_export_link: passed." || echo "test_lifecycle_export_link: FAILED."
	...
	@echo "test_lifecycle_governance_index_contract_compile: compile-check passed."
	@echo "test_lifecycle_governance_index_include_ban: compile-check passed."
	./tests/console/test_lifecycle_governance_index_link && echo "test_lifecycle_governance_index_link: passed." || echo "test_lifecycle_governance_index_link: FAILED."
	@echo "test_lifecycle_governance_provenance_contract_compile: compile-check passed."
	@echo "test_lifecycle_governance_provenance_include_ban: compile-check passed."
	./tests/console/test_lifecycle_governance_provenance_link && echo "test_lifecycle_governance_provenance_link: passed." || echo "test_lifecycle_governance_provenance_link: FAILED."
	...
	@echo "test_lifecycle_governance_manifest_contract_compile: compile-check passed."
	@echo "test_lifecycle_governance_manifest_include_ban: compile-check passed."
	./tests/console/test_lifecycle_governance_manifest_link && echo "test_lifecycle_governance_manifest_link: passed." || echo "test_lifecycle_governance_manifest_link: FAILED."
...
tests/console/test_lifecycle_introspection_contract_compile.o: tests/console/test_lifecycle_introspection_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_introspection_include_ban.o: tests/console/test_lifecycle_introspection_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_introspection_link: tests/console/test_lifecycle_introspection_link.c \
                                                 core/lifecycle_introspection.c
	$(CC) $(TEST_CFLAGS) $^ -o $@
...
tests/console/test_lifecycle_provenance_contract_compile.o: tests/console/test_lifecycle_provenance_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_provenance_include_ban.o: tests/console/test_lifecycle_provenance_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_provenance_link: tests/console/test_lifecycle_provenance_link.c \
                                              core/lifecycle_provenance.c
	$(CC) $(TEST_CFLAGS) $^ -o $@
...
tests/console/test_lifecycle_documentation_contract_compile.o: tests/console/test_lifecycle_documentation_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_documentation_include_ban.o: tests/console/test_lifecycle_documentation_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_documentation_link: tests/console/test_lifecycle_documentation_link.c \
                                                  core/lifecycle_documentation.c
	$(CC) $(TEST_CFLAGS) $^ -o $@

tests/console/test_lifecycle_audit_contract_compile.o: tests/console/test_lifecycle_audit_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_audit_include_ban.o: tests/console/test_lifecycle_audit_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_audit_link: tests/console/test_lifecycle_audit_link.c \
                                          core/lifecycle_audit.c
	$(CC) $(TEST_CFLAGS) $^ -o $@

tests/console/test_lifecycle_export_contract_compile.o: tests/console/test_lifecycle_export_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_export_include_ban.o: tests/console/test_lifecycle_export_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_export_link: tests/console/test_lifecycle_export_link.c \
                                           core/lifecycle_export.c
	$(CC) $(TEST_CFLAGS) $^ -o $@

tests/console/test_lifecycle_extension_contract_compile.o: tests/console/test_lifecycle_extension_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_extension_include_ban.o: tests/console/test_lifecycle_extension_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_extension_link: tests/console/test_lifecycle_extension_link.c \
                                              core/lifecycle_extension.c
	$(CC) $(TEST_CFLAGS) $^ -o $@
...
tests/console/test_lifecycle_governance_index_contract_compile.o: tests/console/test_lifecycle_governance_index_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_index_include_ban.o: tests/console/test_lifecycle_governance_index_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_index_link: tests/console/test_lifecycle_governance_index_link.c \
                                                     core/lifecycle_governance_index.c
	$(CC) $(TEST_CFLAGS) $^ -o $@

tests/console/test_lifecycle_governance_provenance_contract_compile.o: tests/console/test_lifecycle_governance_provenance_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_provenance_include_ban.o: tests/console/test_lifecycle_governance_provenance_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_provenance_link: tests/console/test_lifecycle_governance_provenance_link.c \
                                                          core/lifecycle_governance_provenance.c
	$(CC) $(TEST_CFLAGS) $^ -o $@

tests/console/test_lifecycle_governance_compatibility_contract_compile.o: tests/console/test_lifecycle_governance_compatibility_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_compatibility_include_ban.o: tests/console/test_lifecycle_governance_compatibility_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_compatibility_link: tests/console/test_lifecycle_governance_compatibility_link.c \
                                                            core/lifecycle_governance_compatibility.c
	$(CC) $(TEST_CFLAGS) $^ -o $@
...
tests/console/test_lifecycle_governance_manifest_contract_compile.o: tests/console/test_lifecycle_governance_manifest_contract_compile.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_manifest_include_ban.o: tests/console/test_lifecycle_governance_manifest_include_ban.c
	$(CC) $(TEST_CFLAGS) -c $< -o $@

tests/console/test_lifecycle_governance_manifest_link: tests/console/test_lifecycle_governance_manifest_link.c \
                                                        core/lifecycle_governance_manifest.c
	$(CC) $(TEST_CFLAGS) $^ -o $@
...
test_lifecycle_documentation_contract_compile.o: tests/console/test_lifecycle_documentation_contract_compile.o
test_lifecycle_documentation_include_ban.o: tests/console/test_lifecycle_documentation_include_ban.o
test_lifecycle_audit_contract_compile.o: tests/console/test_lifecycle_audit_contract_compile.o
test_lifecycle_audit_include_ban.o: tests/console/test_lifecycle_audit_include_ban.o
test_lifecycle_export_contract_compile.o: tests/console/test_lifecycle_export_contract_compile.o
...
test_lifecycle_governance_index_contract_compile.o: tests/console/test_lifecycle_governance_index_contract_compile.o
test_lifecycle_governance_index_include_ban.o: tests/console/test_lifecycle_governance_index_include_ban.o
test_lifecycle_governance_provenance_contract_compile.o: tests/console/test_lifecycle_governance_provenance_contract_compile.o
...
test_lifecycle_governance_manifest_contract_compile.o: tests/console/test_lifecycle_governance_manifest_contract_compile.o
test_lifecycle_governance_manifest_include_ban.o: tests/console/test_lifecycle_governance_manifest_include_ban.o
